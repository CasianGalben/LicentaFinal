...
public class Test4 extends AppCompatActivity implements View.OnClickListener {
    ...
    private Intrebare[] mIntrebari = new Intrebare[]{  // creem o banca de obiecte de timpul intrebare care ia din string intrebarile
            new Intrebare(R.string.Intreabare41, true),
            new Intrebare(R.string.Intreabare42, true),
            new Intrebare(R.string.Intreabare43, false),
            new Intrebare(R.string.Intreabare44, true),
            new Intrebare(R.string.Intreabare45, true),
            new Intrebare(R.string.Intreabare46, false),
            new Intrebare(R.string.Intreabare47, false),
            new Intrebare(R.string.Intreabare48, false),
            new Intrebare(R.string.Intreabare49, false),
    };
            ...
            case R.id.bt_True:
                ...
                VerificareRaspunsCorect.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Toast.makeText( Test4.this,"Pana acum ai "+ finalRaspunsuriCorecte+" răspunsuri corecte",Toast.LENGTH_LONG).show();
            ...
            case R.id.btn_False:
                ...
                VerificareRaspunsGresit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Toast.makeText( Test4.this,"Pana acum ai "+finalRaspunsuriGresite+" răspunsuri gresite",Toast.LENGTH_LONG).show();
