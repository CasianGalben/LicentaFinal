...
public class Test3 extends AppCompatActivity implements View.OnClickListener {
    ...
    private Intrebare[] mIntrebari = new Intrebare[]{  // creem o banca de obiecte de timpul intrebare care ia din string intrebarile
            new Intrebare(R.string.Intreabare31, true),
            new Intrebare(R.string.Intreabare32, false),
            ...
            case R.id.bt_True:
                ...
                VerificareRaspunsCorect.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Toast.makeText(Test3.this,"Pana acum ai "+ finalRaspunsuriCorecte+" răspunsuri corecte",Toast.LENGTH_LONG).show();
            ...
            case R.id.btn_False:
                ...
                VerificareRaspunsGresit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Toast.makeText(Test3.this,"Pana acum ai "+finalRaspunsuriGresite+" răspunsuri gresite",Toast.LENGTH_LONG).show();
