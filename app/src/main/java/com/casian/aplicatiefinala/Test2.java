            ...
            case R.id.bt_True:
                ...
                VerificareRaspunsCorect.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Toast.makeText(Test2.this,"Pana acum ai "+ finalRaspunsuriCorecte+" răspunsuri corecte",Toast.LENGTH_LONG).show();
            ...
            case R.id.btn_False:
                ...
                VerificareRaspunsGresit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Toast.makeText(Test2.this,"Pana acum ai "+finalRaspunsuriGresite+" răspunsuri gresite",Toast.LENGTH_LONG).show();
